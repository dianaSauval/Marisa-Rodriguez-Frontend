    ...
    <footer className="footer-marisa">
      <div className="footer-container">
        ...
        <div className="footer-social">
          <a
            href="https://www.instagram.com/marisa.rodz/"
            target="_blank"
          ...
          <a
            href="https://wa.me/5491124596372?text=Hola!%20Quiero%20informacion%20sobre%20los%20cursos%20y%20las%20clases."
            target="_blank"
            rel="noopener noreferrer"
          >
      ...
      <div className="footer-bottom">
        <p>
          © {new Date().getFullYear()} Marisa Rodríguez · Todos los derechos
          reservados
        </p>

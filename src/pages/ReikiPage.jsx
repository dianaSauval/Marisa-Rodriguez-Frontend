...
export default function ReikiPage() {
  ...
  return (
    <>
      <Helmet>
        <title>Reiki | Marisa Rodríguez</title>
        <link
          rel="canonical"
          href="https://marisarodriguezterapiasholisticas.com/reiki"
        />
        <meta
          name="description"
          content="Descubrí la energía sanadora del Reiki. Cursos grabados, clases en vivo y sesiones con Marisa Rodríguez, Maestra de Reiki y canalizadora."
        />
      </Helmet>

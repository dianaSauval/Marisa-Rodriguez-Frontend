...
export default function TerapiasPage() {
  ...
  return (
    <>
      <Helmet>
        <title>Terapias de Luz y Energía | Marisa Rodríguez</title>
        <link
          rel="canonical"
          href="https://marisarodriguezterapiasholisticas.com/terapias-de-luz"
        />
        <meta
          name="description"
          content="Terapias vibracionales, canalizaciones y armonización energética. Sesiones y cursos para reconectar con tu esencia."
        />
      </Helmet>
      ...
      <div className="cursos-container">
        <section className="encabezado-cursos">
          ...
          <p>
            Técnicas sutiles que armonizan tu energía y te conectan con planos
            más elevados de conciencia. Un viaje hacia tu luz interior.
          </p>
        </section>
        ...
        {loading ? (
          ...
          <section className="grid-cursos">
            {cursos.map((curso) => (
              <div
                key={curso._id}
                className={`curso-card luzYEnergia ${
